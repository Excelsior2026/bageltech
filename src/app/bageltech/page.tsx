...
const bageltech = WORKSTREAMS.find((stream) => stream.slug === "bageltech") ?? WORKSTREAMS[0];

export const metadata: Metadata = {
  title: "BagelTech | Products and Platforms",
  description:
    "Governable AI systems, decision workflows, and institution-facing products for environments where confident mistakes are expensive.",
};
...
export default function BagelTechPage() {
  return (
    <MarketingLayout>
          ...
          <div className={`${styles.inner} ${styles.pageHeroGrid}`}>
            <ScrollReveal>
              ...
              <p className={styles.bodyText}>
                {bageltech.description} The work is commercial and implementation-oriented: products, pilots, and
            ...
            <ScrollReveal className={styles.imagePanel} delay={120}>
              <MarketingImage src={bageltech.image.src} alt={bageltech.image.alt} priority />
